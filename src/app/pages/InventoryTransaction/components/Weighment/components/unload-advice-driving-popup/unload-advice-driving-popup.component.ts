...
import {MAT_DIALOG_DATA, MatDialogRef} from "@angular/material";
  ...
  @Component({
    selector: 'app-unload-advice-driving-popup',
    templateUrl: './unload-advice-driving-popup.component.html',
    styleUrls: ['./unload-advice-driving-popup.component.scss']})

  export class UnloadAdviceDrivingPopupComponent implements OnInit 
  {   
    submitted= false;
    ...
    constructor(private Service:Master,public fb:FormBuilder,
      ...
      private dialogRef: MatDialogRef<UnloadAdviceDrivingPopupComponent>, @Inject(MAT_DIALOG_DATA)data) 
    { 
    ...
    ngOnInit()
    {
      ...
      if(this.transporter_id == '0' || this.transporter_id == null || this.transporter_id =='')
      {
      ...
      {
        this.DropDownListService.getVehicleThruTransporter(this.transporter_id).subscribe(data=>
          {
            this.veh_nos = data;
            this.status = true;
          });
