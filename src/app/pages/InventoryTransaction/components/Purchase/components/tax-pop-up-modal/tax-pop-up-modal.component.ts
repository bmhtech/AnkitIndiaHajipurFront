...
import { DropdownServiceService } from '../../../../../../service/dropdown-service.service';
  ...
  @Component({
    selector: 'app-tax-pop-up-modal',
    templateUrl: './tax-pop-up-modal.component.html',
    styleUrls: ['./tax-pop-up-modal.component.scss']})

  export class TaxPopUpModalComponent implements OnInit 
  {
  ...
  constructor( private fb: FormBuilder, private Service: Master,
    ...
    private dialogRef: MatDialogRef<TaxPopUpModalComponent>,@Inject(MAT_DIALOG_DATA)data)
  {
