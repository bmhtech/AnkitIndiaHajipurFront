...
import { DropdownServiceService } from '../../../../../../service/dropdown-service.service';
  ...
  @Component({
    selector: 'app-sales-quo-tax-modal',
    templateUrl: './sales-quo-tax-modal.component.html',
    styleUrls: ['./sales-quo-tax-modal.component.scss']
  })

  export class SalesQuoTaxModalComponent implements OnInit 
  {
  ...
  constructor( private fb: FormBuilder, private Service: Master,
    ...
    private dialogRef: MatDialogRef<SalesQuoTaxModalComponent>,@Inject(MAT_DIALOG_DATA)data)
  {
