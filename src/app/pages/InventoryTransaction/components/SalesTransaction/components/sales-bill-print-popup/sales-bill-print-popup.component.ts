...
@Component({
  selector: 'app-sales-bill-print-popup',
  templateUrl: './sales-bill-print-popup.component.html',
  styleUrls: ['./sales-bill-print-popup.component.scss']
})
export class SalesBillPrintPopupComponent implements OnInit {
  Invoice_Id:any;
  MainId:any;
  ...
  constructor( private fb: FormBuilder,private Service: Master,
    ...
    private dialogRef: MatDialogRef<SalesBillPrintPopupComponent>, @Inject(MAT_DIALOG_DATA)data)
  { 
  ...
  onUpdate(id,Invoice_Id)
  {
    ...
    forkJoin(
     ...
     // this.DropDownListService.geteinvoicedetails(this.Invoice_Id),
     // this.DropDownListService.getEinvoiceImage(imagename)
    ...
    ).subscribe(([SalesInvoiceData,Itemdata,TaxData ,TransData,ShipmentData,Hsndata,TaxSummData,Taxgstno,compdetails])=>
      {
         ...
         if(SalesInvoiceData.e_invoice_no.length)
         {
          this.imagename=this.Invoice_Id+'.png';
         ...
         forkJoin(
          ...
          ).subscribe(([einvoice,imagesource])=>
          {
            ...
            this.ackno=einvoice["ack_no"];
            this.ackdate=einvoice["ack_date"];
          });
        
       // this.imagepath="G:/Aayog_Einvoice/SI09442.png";
        ...
        this.pan_no=compdetails.pan_no;
        ...
        this.Sgst =  this.Cgst;
        this.waybill=SalesInvoiceData["waybill"];
        this.salesorderdate=SalesInvoiceData["salesorderdate"];
