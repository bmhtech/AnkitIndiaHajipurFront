...
import { DropdownServiceService } from '../../../../../../service/dropdown-service.service';
  ...
  @Component({
    selector: 'app-sales-qc-popup',
    templateUrl: './sales-qc-popup.component.html',
    styleUrls: ['./sales-qc-popup.component.scss']
  })

  export class SalesQcPopupComponent implements OnInit 
  {
    ...
    constructor(  private fb: FormBuilder,private Service: Master,
      ...
      private dialogRef: MatDialogRef<SalesQcPopupComponent>,@Inject(MAT_DIALOG_DATA) data)
    {
