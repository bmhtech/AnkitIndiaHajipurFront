...
export class ProductionreportComponent implements OnInit {
  ...
  search()
  {
    ...
    forkJoin(
      this.DropDownListService.getProdInputReport(business_unit,shop_floor,this.fromdate1,this.todate1),
      this.DropDownListService.getProdOutputReport(business_unit,shop_floor,this.fromdate1,this.todate1),
