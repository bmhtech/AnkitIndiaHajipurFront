...
@Component({
  selector: 'app-itemallocationpoitemtagging',
  templateUrl: './itemallocationpoitemtagging.component.html',
  styleUrls: ['./itemallocationpoitemtagging.component.scss']
})
export class ItemallocationpoitemtaggingComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private Service: Master,
    ...
    private dialogRef: MatDialogRef<ItemallocationpoitemtaggingComponent>,
  ...
  SendDataToDifferentComponenetold() {
