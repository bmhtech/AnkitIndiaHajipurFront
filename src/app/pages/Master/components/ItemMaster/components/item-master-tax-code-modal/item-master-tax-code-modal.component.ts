...
import { TaxList, Tax_code_details } from '../../../../../../Models/InventoryModel/TaxCode';
import { DropdownServiceService } from '../../../../../../service/dropdown-service.service';

  @Component({
    selector: 'app-item-master-tax-code-modal',
    templateUrl: './item-master-tax-code-modal.component.html',
    styleUrls: ['./item-master-tax-code-modal.component.scss']
  })

  export class ItemMasterTaxCodeModalComponent implements OnInit 
  {
    ...
    constructor( private fb: FormBuilder, private Service: Master,
      ...
      private dialogRef: MatDialogRef<ItemMasterTaxCodeModalComponent>, @Inject(MAT_DIALOG_DATA) data)
    {
